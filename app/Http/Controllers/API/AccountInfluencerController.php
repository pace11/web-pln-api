...
class AccountInfluencerController extends ResponseController
{
    ...
    public function index(Request $request) {
        ...
        $account = AccountInfluencer::with(['user'])->whereYear('period_date', $year)->orderBy('period_date', 'asc')->paginate(10);
    ...
    public function indexYear(Request $request) {
        $year = AccountInfluencer::select(\DB::raw('YEAR(period_date) as year'))->groupBy('year')->get();
