...
class InternalCommunicationController extends ResponseController
{
    ...
    public function index(Request $request) {
        ...
        $account = InternalCommunication::with(['user'])->whereYear('period_date', $year)->orderBy('period_date', 'asc')->paginate(10);
    ...
    public function indexYear(Request $request) {
        $year = InternalCommunication::select(\DB::raw('YEAR(period_date) as year'))->groupBy('year')->get();
